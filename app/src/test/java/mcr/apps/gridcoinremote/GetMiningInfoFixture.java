...
public class GetMiningInfoFixture {
    ...
    @Test
    public void GivenGetMiningInfoWhenGetNetWeightThenExpectedValueReturned() {
    ...
    @Test
    public void GivenGetMiningInfoWhenGetStakingThenExpectedValueReturned() {
        GridcoinData data = new GridcoinData();
        sut.populateMiningInfo(data);
    ...
    @Test
    public void GivenGetMiningInfoWhenGetPoRDiffThenExpectedValueReturned() {
        GridcoinData data = new GridcoinData();
        sut.populateMiningInfo(data);
    ...
    @Test
    public void GivenGetMiningInfoWhenGetBlocksThenExpectedValueReturned() {
        GridcoinData data = new GridcoinData();
        sut.populateMiningInfo(data);
    ...
    @Test
    public void GivenGetMiningInfoWhenGetCpidThenExpectedValueReturned() {
        GridcoinData data = new GridcoinData();
        sut.populateMiningInfo(data);
    ...
    @Test
    public void GivenGetMiningInfoWhenGetGrcMagUnitThenExpectedValueReturned() {
        GridcoinData data = new GridcoinData();
        sut.populateMiningInfo(data);
